...
<div align="center" >
  <h1>INSERTAR EN ORDEN DE COMPRA </h1>
  <h2><a href='../provedores/info_provedores.php?redirec=../orden_compra/orden_compra.php'>SIQUIENTE</A></h2>
  <?php
  if(empty($_GET['id_prod']))
  {
  ?>
...
?>
  ...
  <table width="800" border="0" cellspacing="2" cellpadding="1"   id="l_precios">
    ...
    <?php
$subtotal=0;
$database->consulta(PRODUCTOS::COTI_TMP." ORDER BY id_coti");
