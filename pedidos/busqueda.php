...
if(!empty($_GET['id_prod']))
{
	...
	";
		...
		$('#sigiente').tics("PASO SIGUIENTE INGRESAR O SELECCIONAR LE CLIENTE");
...
<div align="center" class="conten_ico" >
	<a href="busqueda.php?desechar=true"><div class="desechar" id="desechar_coti"></div></a>
	<?php
			if(!empty($_GET['id_prod']))
		{
		...
		{
			echo "<a href='buscar_pedido.php'><div class='atras'></div></a>";
		}

	?></div>
<div align="center" >
	<h1>INSERTAR EN PEDIDO </h1>


	<h2><a href='../clientes/info_cliente.php?redirec=../pedidos/pedido.php' id="sigiente">SIQUIENTE</A></h2> 
	<?php
if(empty($_GET['id_prod']))
{
	?>
...
<form action="" method="post" >
 ...
 while($campo=$database->result())
 {
	 echo " <option value='$campo[exad]'  style='color:$campo[exad];'>$campo[desc_colo]</option>";
				...
				</select><div id="otro_color" style="display:none;">
 ...
 $conf=$database->config();
			...
			<th><div id="precio"><?php echo fmt_num((float)$costo) ?> bsf	</div> <div id="otro_pre" class="edit"></div></th>
...
<table width="800" border="0" cellspacing="2" cellpadding="1"   id="l_precios">
	...
	<td  width="100"  scope="col"  >PRECIO
	</td>
	<td  width="100"  scope="col"  >CANTIDAD
	</td>
	<td width="50" scope="col" >ACCION
	</td>
	</tr>
<?php
